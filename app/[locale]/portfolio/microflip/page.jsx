...
const ProjectIcon = dynamic(() => import('../../../../public/portfolio/microflip/icon'), { ssr: false })
...
export default async function Page({ params }) {
  ...
  return (
    <article className="max-w-4xl">
      ...
      <PortfolioContent readmePath="public/portfolio/microflip/README.md" locale={locale} />
    </article>
  )
}
