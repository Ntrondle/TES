...
export default function PowerClient({ features, t, locale }) {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <section className="mt-12">
        <motion.h2 
          ...
          viewport={{ once: true }}
        >
          {t.servicePages.power.featuresTitle}
        </motion.h2>
      ...
      >
        <div className="rounded-3xl bg-gradient-to-br from-neutral-900 to-neutral-800 dark:from-neutral-800 dark:to-neutral-900 p-8 md:p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">
            {t.servicePages.power.ctaTitle}
          </h2>
          <p className="text-neutral-300 mb-6 max-w-2xl mx-auto">
            {t.servicePages.power.ctaSubtitle}
          </p>
          <a
          ...
          >
            {t.servicePages.power.ctaButton}
