...
export default function PrototypingPage({ params: { locale } }) {
  const services = [
    {
      icon: Settings,
      title: "Board Bring-up",
      description: "Power-on verification, oscillator testing, and basic functionality validation"
    },
    {
      icon: Search,
      title: "Debugging & Testing",
      description: "Systematic troubleshooting with oscilloscopes, logic analyzers, and custom test equipment"
    },
    {
      icon: Wrench,
      title: "Test Jigs & Fixtures",
      description: "Custom test equipment and automated testing solutions for production validation"
    },
    {
      icon: ClipboardCheck,
      title: "Validation & Verification",
      description: "Comprehensive testing against specifications and requirements"
    }
  ]
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-xl text-neutral-600 dark:text-neutral-300 mt-4">
          Rapid prototyping and comprehensive testing to validate your designs quickly and confidently. From first prototypes to production-ready validation.
        </p>
      </motion.div>
              ...
              <div className="p-6 rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
                <div className="flex items-start gap-3">
                  <div className="p-2 rounded-lg bg-neutral-100 dark:bg-neutral-800 shrink-0">
                    <service.icon className="w-5 h-5 text-neutral-900 dark:text-white" />
                  </div>
                  <div>
